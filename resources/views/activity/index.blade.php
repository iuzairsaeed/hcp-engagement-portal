                        ...
                        <div class="col-lg-3 col-sm-12 pl-2 pr-2 mt-3">
                            <div class=" p-2 card border-0 border-radius10px">
                              ...
                              <div class="card-body text-left pt-2 pb-0 pl-1 pr-1">
                                <a href="{{ route("download", $gamification->id)  }}" target="_blank" class="bg-white col-auto border-0 float-right p-0 coloricon rounded-circle text-center mt-minus mr-2" style="width: 28px;height: 28px;"><img src="{{ asset('images/Asset90.png') }}" class="iconsize m-auto"></a>
