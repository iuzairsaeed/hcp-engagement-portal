                   ...
                   <div class="col-sm-12 mt-4">
                                    <div class="w-100 pt-3 pb-3 pl-4 pr-4 border-radius10px bg-white position-relative" style="box-shadow: 1px 1px 10px #a1c0cc;">
                                            <div class="media">
                                                  ...
                                                  <img src="{{asset('images/Asset56.png') }}" class="mr-3 mt-3 rounded-circle" style="width:160px;height: 160px;">
                                                  <div class="media-body mt-5">
                                                    <p class="w-100 font-gothamlight text-darkgray fontsize11px mb-2">General Information</p>
                                                    <h5 class="mb-0 w-100"><input type="text" name="name" value="Mansoor Ahmed" disabled class="bg-transparent border-0 outline-none font-gothambook text-dark"> </h5>
                                                    <p class="mb-0 w-100"><input type="text" name="advice" value="Substance Abuse" disabled class="bg-transparent border-0 outline-none font-gothamlight fontsize14px"> </p>
                                                    <ul class="list-unstyled d-inline-block p-0 d-flex flex-wrap w-100 mb-4">
                                                        <li class="col-sm-2 p-0"><i class="fa fa-map-marker text-blue" style="font-size: 13px;"></i> <input type="text" name="advice" value="Karachi, Pakistan" class="bg-transparent border-0 text-gray fontsize13px" disabled style="width: 90%"></li>
                                                        <li class="col-sm-3 p-0 ml-2"><i class="fa fa-envelope text-blue" style="font-size: 13px;"></i> <input type="text" name="advice" value="mansoor.ahmed@example.com" class="bg-transparent border-0 text-gray fontsize13px" disabled style="width: 91%;"></li>
                                                        <li class="col-sm-3 ml-2 p-0"><i class="fa fa-phone text-blue" style="font-size: 13px;"></i> <input type="text" name="advice" value="+9230012345667" class="bg-transparent border-0 text-gray fontsize13px" disabled style="width: 90%;"></li>
                                                    </ul>
