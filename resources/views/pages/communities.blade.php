                                                         ...
                                                         <div class="col-sm-3 p-2">
                                                            <div class="w-100 p-2 card border-0 border-radius10px" style="box-shadow: 1px 1px 13px #b2cfda;">
                                                                    <div class="overflow-hiden w-100 position-relative h-img rounded">
                                                                          <img class="card-img-top w-100" src="{{asset('images/Asset39.png') }}">
                                                                           <div class="text-center position-absolute overlay-effect">
                                                                                    <h6 class="font-gothamlight fontsize14px mb-0 text-white p-2" > Dr Shams </h6>
                                                                                </div>
                                                                             </div>
                                                                              <div class="card-body text-left pt-2 pb-0 pl-2 pr-2">
                                                                               <ul class="list-unstyled d-inline-block pb-2 d-flex flex-wrap w-100 mb-2 border-bottom border-gray">
                                                                                    <li class="col-sm-5 col-5 p-0 m-auto"><h6 class="bg-transparent border-0 text-dark fontsize10px font-gothambook mb-0"><i class="fa fa-bookmark-o fontsize12px mr-1" ></i> Master </h6> </li>
                                                                                     ...
                                                                                     <li class="col-sm-3 col-3 p-0 text-right">
                                                                                        <a href="#" data-toggle="modal" onclick="openPopUp(this)" data-target="#Messagemodal"><i class="fa fa-envelope-o mr-1 text-dark fontsize15px"></i></a>
