                    ...
                    <div class="col-sm-12 mt-4">
                            <div class="w-100 border-radius10px pt-4 pb-5 pl-4 pr-4 text-center bg-white">
                                    ...
                                    <div class="w-100 text-center bg-gray pt-3 pb-3" style="margin-top: -4px">
                                            ...
                                            <a href="#" class="pl-1 pr-1"><img src="{{asset('images/Asset69.png')}}" width="25"></a>
                                            <a href="#" class="pl-1 pr-1"><img src="{{asset('images/Asset70.png')}}" width="25"></a>
                                            <a href="#" class="pl-1 pr-1"><img src="{{asset('images/Asset71.png')}}" width="25"></a>
                                    </div>
                    </div>
                        <!-- /.container-fluid -->
