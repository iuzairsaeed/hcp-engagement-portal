                                    ...
                                    <div class="w-100 pt-3 pb-3 pl-4 pr-4 border-radius10px bg-white position-relative" style="box-shadow: 1px 1px 10px #a1c0cc;">
                                            <div class="media">
                                                  ...
                                                  <div class="media-body mt-5">
                                                    ...
                                                    <p class="mb-0 w-100"><input type="text" name="advice" value="{{ $user->speciality->first()->name }}" disabled class="bg-transparent border-0 outline-none font-gothamlight fontsize14px"> </p>
                                                    <ul class="list-unstyled d-inline-block p-0 d-flex flex-wrap w-100 mb-4">
                                                        <li class="col-sm-2 p-0"><i class="fa fa-map-marker text-blue" style="font-size: 13px;"></i> <input type="text" name="advice" value="{{ $user->location->first()->name }}" class="bg-transparent border-0 text-gray fontsize13px" disabled style="width: 90%"></li>
